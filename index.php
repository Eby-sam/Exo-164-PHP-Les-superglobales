...
$serveur = [
            $_SERVER['PHP_SELF'], $_SERVER['SERVER_NAME'], $_SERVER['SERVER_ADDR'], $_SERVER['REMOTE_ADDR'],
            $_SERVER['HTTPS'], $_SERVER['REQUEST_TIME'], $_SERVER['DOCUMENT_ROOT'], $_SERVER['HTTP_ACCEPT']
];
